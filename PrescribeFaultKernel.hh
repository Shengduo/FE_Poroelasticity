...
public:
    ...
    /** Default constructor */
    PrescribeFaultKernel() {};

    /** Default Virtual destructor */
    virtual ~PrescribeFaultKernel() {};

// NOT IMPLEMENTED
private:
    // Copy constructor
    PrescribeFaultKernel(const PrescribeFaultKernel &); 
    
    // Move-assign operator
    const PrescribeFaultKernel & operator=(const PrescribeFaultKernel &);
}; 